...
<x-layouts.layout>
    ...
    <div class="p-2 bg-gray-200">
        <a class="btn btn-sm btn-secondary " href="{{route("usuarios.create")}}">Crear alumno</a>
    ...
    <div class="max-h-full overflow-x-auto">
        <table class="table table-xs table-pin-rows table-pin-cols">
            ...
            {{--El edit--}}
                    <td>
                        <a href="{{route("usuarios.edit", $fila->id)}}">
...
{{--                        Vero o show--}}
                    <td><a href="{{route("usuarios.show", $fila->id)}}">Ver</a></td>
                </tr>
